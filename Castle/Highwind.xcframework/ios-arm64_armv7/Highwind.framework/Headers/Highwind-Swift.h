...
///
- (nonnull instancetype)initWithVersion:(NSString * _Nonnull)version uuid:(NSString * _Nonnull)uuid userAgent:(NSString * _Nonnull)userAgent OBJC_DESIGNATED_INITIALIZER;
