...
#ifndef HIGHWIND_SWIFT_H
#define HIGHWIND_SWIFT_H
...
///
- (nullable instancetype)initWithVersion:(NSString * _Nonnull)version uuid:(NSString * _Nonnull)uuid publishableKey:(NSString * _Nonnull)publishableKey userAgent:(NSString * _Nonnull)userAgent error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
